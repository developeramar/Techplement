    ...
    <body>
        ...
        <nav class="navbar bg-light">
            <div class="container">
                ...
                <div class="d-flex justify-content-end logout-btn"><a href="./Result.php">Logout</a></div>
            </div>
        </nav>
        <!-- ./Navbar -->
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="assets/backend/todo.php" method="post">
                                            ...
                                            <input type="text" name="update-todo" value="<?php echo $row['tasks']; ?>" required />
                                            <button class="btn btn-success" name="update-todo-btn" type="submit">Update</button>
                                            <button class="btn btn-danger" name="dlt-todo-btn" type="submit">Delete</button>
                                        </form>
                                    </td>
                                </tr>
                            <?php } ?>
